...
public class DateUtil {
	 ...
	 * @return
	 */
	public static String getStrDate_12(Date currentTime){
	 ...
	 * @return
	 */
	public static String getStrDate_24(Date currentTime){
		SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		String strDate = formatter.format(currentTime);
		return strDate;
	}
	 ...
	 * @return
	 */
	public static String getStrDateS(Date currentTime){
	 ...
	 * @return strDate
	 */
	public static String getNowStrDate(Date date){
	 ...
	 * @return
	 */
	public static String getLongDateS(Date date){
	...
	public static Date otherDate(String strDate,String formatDate,int num) throws ParseException{
	 ...
	 public static String getNowMonth(String sdate) {
	  ...
	  String newday = DateUtil.getNextDay(sdate, String.valueOf(1-u));
	  return newday;
	 }
	 ...
	 @Test
	 public void test (){
		 System.out.println(getNowStrDate(new Date()));
	 }
}
